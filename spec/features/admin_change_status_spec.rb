...
feature 'Change status' do
  scenario 'successfully' do
    ...
    registration = create(:registration,name:'Diogo',cpf:'123456',unity_id: 1, plan_id: 1, pay_method_id: 1)
    payment = registration.payments.create!(value:50,registration_id: 1,pay_method_id: 1,dt_venc:'2019-09-10 18:20:44')
